...
public interface IGuardedSignalCommandMap extends ISignalCommandMap {
     ...
     *
     * <p>The <code>signal</code> - an instance of SignalBase</p>
     ...
     */
    function mapGuardedSignal(signal:SignalBase, commandClass:Class, guards:*, oneshot:Boolean = false):void;

    /**
     * Map a Command to an instance of a Signal, with Guards
     *
     * <p>The <code>signalClass</code> - a Class implementing SignalBase</p>
     * <p>The <code>commandClass</code> must implement an execute() method</p>
     * <p>The <code>guards</code> must be a Class which implements an approve() method</p>
     * <p>or an <code>Array</code> of Classes which implements an approve() method</p>
     *
     ...
     * @throws org.robotlegs.base::ContextError
     */
    function mapGuardedSignalClass(signalClass:Class, commandClass:Class, guards:*, oneShot:Boolean = false):SignalBase;
     ...
     * @throws org.robotlegs.base::ContextError
     */
    function mapGuardedSignalWithFallback(signal:SignalBase, commandClass:Class, fallbackCommandClass:Class, guards:*, oneshot:Boolean = false):void;
     ...
     * @throws org.robotlegs.base::ContextError
     */
    function mapGuardedSignalClassWithFallback(signalClass:Class, commandClass:Class, fallbackCommandClass:Class, guards:*, oneShot:Boolean = false):SignalBase;
